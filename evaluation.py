...
def test_model_multitask(args, model, device, evalOnTest = True, writePreds = True):
    ...
    with torch.no_grad():
        ...
        if evalOnTest:
            sst_test_data, num_labels,para_test_data, sts_test_data, nli_test_data = \
                load_multitask_data(args.nli_test, args.sst_test,args.para_test, args.sts_test, split='test')
            ...
            print("TEST DATA LOADED AND EVALED")
        
        sst_dev_data, num_labels,para_dev_data, sts_dev_data, nli_dev_data = \
            load_multitask_data(args.nli_dev, args.sst_dev,args.para_dev,args.sts_dev,split='dev')
        ...
        dev_paraphrase_accuracy, dev_para_y_pred, dev_para_sent_ids, \
            dev_sentiment_accuracy,dev_sst_y_pred, dev_sst_sent_ids, dev_sts_corr, \
                dev_sts_y_pred, dev_sts_sent_ids = model_eval_multitask(sst_dev_dataloader,
                                                                        ...
                                                                        oldReturn = True)
        print("TRAIN DATA LOADED AND EVALED")
